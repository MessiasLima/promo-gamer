...
class LatestDealsGamesNavigatorImpl @Inject constructor(
    private val latestDealsGamesViewModelFactory: LatestDealsGamesViewModelFactory
) : LatestDealsGamesNavigator {
